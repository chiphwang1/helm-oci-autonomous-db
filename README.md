...
Modify the following variables in the script prior to running the script.
...
```
**2. You can extract the wallet files with the check_autodb.py script in the python directory.**.
